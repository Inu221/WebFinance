...
const API_URL = "/api/commodities";

export default function Commodities({ darkMode }) {
    ...
    <div className="container mx-auto max-w-7xl px-6 py-16 space-y-12 animate-fadeSlideUp">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-lg">
          Следите за изменением цен на сырьевые товары в реальном времени.
        </p>
      </div>
